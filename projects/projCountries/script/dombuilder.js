...
import { searchFullHeart } from "./hearts.js";
import { pushToLocalStorageHearts } from "./storage.js";
...
export const createCard = (country) => {
  ...
  heart.addEventListener("click", () => {
    if (heart.className === "bi bi-heart") {
      heart.className = "bi bi-heart-fill";
      pushToLocalStorageHearts(country, true);
    } else {
      heart.className = "bi bi-heart";
      pushToLocalStorageHearts(country, false);
    }
  });
